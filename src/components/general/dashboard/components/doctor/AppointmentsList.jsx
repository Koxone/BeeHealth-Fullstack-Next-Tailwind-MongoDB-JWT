...
export default function AppointmentsList() {
  ...
  return (
    <div className="space-y-4">
      {/* Example item */}
      <div className="relative cursor-pointer overflow-hidden rounded-2xl border-2 border-gray-200 bg-white p-5 transition-all duration-300 hover:scale-[1.02] hover:border-blue-300 hover:shadow-xl">
        <div className="absolute -top-8 -right-8 h-32 w-32 rounded-full bg-blue-500 opacity-5" />

        <div className="relative z-10 grid w-full grid-rows-[auto_1fr] gap-2 sm:items-center">
          <div className="flex w-full items-center gap-4">
            ...
            {/* Info */}
            <div className="flex w-fit min-w-0 flex-col items-center space-y-2">
          ...
          {/* Action buttons */}
          {/* <div className="flex shrink-0 justify-center gap-2 sm:flex-col lg:flex-row">
