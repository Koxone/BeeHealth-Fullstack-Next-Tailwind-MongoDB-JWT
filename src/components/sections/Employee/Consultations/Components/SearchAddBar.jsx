  ...
  return (
    <div className="rounded-2xl border-2 border-gray-200 bg-white p-4 shadow-lg">
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <button
          onClick={onAdd}
          className="group flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-3 font-semibold text-white shadow-lg shadow-indigo-500/30 transition hover:from-indigo-700 hover:to-purple-700 active:scale-95"
        >
