...
export default function DeleteModal({ open, onClose, item, activeTab, onConfirm }) {
          ...
          <div className="p-6">
            ...
            <div className="mb-6 rounded-lg bg-gray-50 p-3">
              <p className="text-sm font-medium text-gray-900">
                {activeTab === 'medicamentos' && item.nombre}
                {activeTab === 'recetas' && item.tipo}
                {activeTab === 'suministros' && item.nombre}
              </p>
            </div>
